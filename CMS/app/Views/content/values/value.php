    ...
    <div class="right-side">
      <aside class="default-section">
        ...
        <a href="/community/secondvalues" class="values">
          <button type="button" class="btn btn-primary btn-lg outline">Halve SS
          </button>
        </a>
        <a href="/community/values" class="values">
          <button type="button" class="btn btn-primary btn-lg outline" style="color: #33a6cc;border-color: #33a6cc;">Super Zeldzaam SS
          </button>
        </a>
      </aside>
    </div>
